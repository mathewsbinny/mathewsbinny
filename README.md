...
- *Mobile-friendly web app being developed for university using a MERN stack (MongoDB, Express, React, Node.js) and styled using Bootstrap CSS. Features integration of Google Maps API for live-trail overlays and JWT for session handling. Currently working on adding Google OAuth to improve security standards.*
