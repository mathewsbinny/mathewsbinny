...
- *Features integration of Google Maps API for live-trail overlays and JWT for session handling.*
- *Currently working on adding Google OAuth to improve security standards & expanding functionalities.*

##### Workout Tracker Web App
 - *Web app created for personal workout tracking using a MERN stack (MongoDB, Express, React, Node.js).*
 - *Current iteration focused on adding user authentication through use of JSON Web Tokens.*
